            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 4;
                  return _this.get('dataService').getBooks(search);
...
define('flexberry-edu/routes/error', ['exports'], function (exports) {
  'use strict';
...
define('flexberry-edu/routes/speakers', ['exports'], function (exports) {
  ...
  var SpeakersIndexRoute = function (_Ember$Route) {
    _inherits(SpeakersIndexRoute, _Ember$Route);

    function SpeakersIndexRoute() {
      _classCallCheck(this, SpeakersIndexRoute);

      return _possibleConstructorReturn(this, (SpeakersIndexRoute.__proto__ || Object.getPrototypeOf(SpeakersIndexRoute)).apply(this, arguments));
    }

    _createClass(SpeakersIndexRoute, [{
      key: 'model',
      value: function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var response, speakers;
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                ...
                case 5:
                  ...
                  return _context.abrupt('return', speakers);
  ...
  exports.default = SpeakersIndexRoute;
});
...
define('flexberry-edu/services/data-service', ['exports'], function (exports) {
    ...
    exports.default = Ember.Service.extend({
        ...
        getSpeakers: function getSpeakers() {
            return fetch('http://localhost:3000/speakers').then(function (response) {
                return response.json();
            });
        },
...
if (!runningTests) {
  require("flexberry-edu/app")["default"].create({"name":"flexberry-edu","version":"0.0.0+9a9ec173"});
}
